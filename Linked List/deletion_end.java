...
Implementation 
1. First we've to check that the list is not empty, if yes then exit.
2. Now the pointer from the second last node will be redirected towards the null pointer.
3. If there is only one node in the linked list then the head will point to the null.
*/
